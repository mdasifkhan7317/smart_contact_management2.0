...
//		contactForm.setFavorite(true);
	...
	public String saveContact(@Valid @ModelAttribute ContactForm contactForm, BindingResult result ,Authentication authentication, HttpSession session) {
		...
		if(result.hasErrors()) {
			...
			session.setAttribute("message", Message.builder().content("Correct the error").type(MessageType.red).build());
			return "user/add_contact";
		}
		
		User user = userServicel.getUserByEmail(username);
	...
	public String searchHandler(@ModelAttribute ContactSearchForm contactSearchForm,
		...
		var user = userServicel.getUserByEmail(Helper.getEmailOfLoggedInUser(authentication));
